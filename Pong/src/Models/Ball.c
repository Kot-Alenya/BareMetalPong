...
Ball* Ball_Create()
{
    Ball* result = calloc(1, sizeof(Ball));
...
int TryOutside(RectangleF rectangle)
{
...
void IncreaseVelocity(Ball *ball, float deltaTime)
{
...
int TryUpDownFlip(Ball *ball, RectangleF rectangle)
{
...
void FlipFromPlatform(Ball *ball, Platform platform, int maxSpread, int rightLeftOffset, int upDownOffset)
{
...
int IsPlatformCollision(Ball *ball, RectangleF rectangle)
{
    int maxSpread = 20;
...
void SetPosition(Ball* ball, Float2 newPosition)
{
